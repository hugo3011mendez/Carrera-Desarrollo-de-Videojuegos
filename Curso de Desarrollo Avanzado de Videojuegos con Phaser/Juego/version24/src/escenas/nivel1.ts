...
export default class Nivel1 extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        this.physics.add.collider(this.bunnyGroup, this.capaTerreno); // Collider de los enemigos con la plataforma

        this.physics.add.overlap(this.jugador, this.bunnyGroup, this.jugador.enemigoToca, null, this); // Collider entre el jugador y los enemigos
    }
