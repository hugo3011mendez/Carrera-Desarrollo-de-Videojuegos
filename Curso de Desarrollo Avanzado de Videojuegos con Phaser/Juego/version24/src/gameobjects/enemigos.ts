...
export default class Enemigos extends Phaser.Physics.Arcade.Group { // Hereda de Arcade Group : Un grupo de spritesheets con físicas
    ...
    constructor(escena: Nivel1, nombreObjeto:string, idObjeto:string, animacionObjeto:string, velocidad:number){
        ...
        this.children.entries.map((enemigo:any)=>{
            ...
            enemigo.body.setSize(30,30); // Tamaño
            enemigo.body.setOffset(0,10); // Offset
