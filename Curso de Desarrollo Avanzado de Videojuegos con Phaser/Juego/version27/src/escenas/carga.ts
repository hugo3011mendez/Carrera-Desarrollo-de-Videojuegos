...
export default class Carga extends Phaser.Scene 
{
    ...
    preload (): void {
      ...
      for (let i=0; i<=2; i++) // Hay 3 identificadores en función del nivel, por lo que los uso en un bucle
        this.load.audio(Constante.SONIDOS.BANDASONORA + i, `sonidos/bandasonora/cartoongame${i}.ogg`);
    }
}